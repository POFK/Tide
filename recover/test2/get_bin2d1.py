...
rank = comm.Get_rank()
########################## Load data ############################################
f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/0.000den00_Pk_delta.hdf5','r')
Pk_d=f['data'][rank*(1024/size):(rank+1)*(1024/size)]
Pk_d=np.array(Pk_d,dtype=np.float)
f.close()

f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/0.000den00_Pk_delta_kappa.hdf5','r')
Pk_kd=f['data'][rank*(1024/size):(rank+1)*(1024/size)]
Pk_kd=np.array(Pk_kd,dtype=np.float)
f.close()

f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/0.000den00_Pk_kappa.hdf5','r')
...
if rank==0:
    ...
    Pn=pk3-b**2*pk1
    W=pk1/(pk1+Pn/(b**2))
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/result_b',b)
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/result_Pn',Pn)
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/result_W',W)
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/result_n',kn)
