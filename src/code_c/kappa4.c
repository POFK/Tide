...
char path1[80] = {"../../tides04/0.000wgam1gd1.25.bin"};
char path2[80] = {"../../tides04/0.000wgam2gd1.25.bin"};
char pathout1[80] = {"../../tides04/0.000wkappagd1.25.bin"};
char pathout2[80] = {"../../tides04/0.000wkappbgd1.25.bin"};
        ...
        for(j = 0; j < nn; j++)  {
            for(i = 0; i < cn2; i++)  {
             ...
             //
                ...
                weight  = pow((kv2/k2), 2);
                gamma1k[index_0][0] = weight*(factor1*r_part1+factor2*r_part2);
                gamma1k[index_0][1] = weight*(factor1*i_part1+factor2*i_part2); 
                gamma2k[index_0][0] = weight*(-factor2*r_part1+factor1*r_part2);
                gamma2k[index_0][1] = weight*(-factor2*i_part1+factor1*i_part2);
                }
           }
        }
    }
