...
int main(void)  {
    ...
    char pathx[80] = {"../../tides03/0.000wdengdx1.25.bin"};
    char pathy[80] = {"../../tides03/0.000wdengdy1.25.bin"};
    
    FILE *DENX = fopen(pathx, "rb");
    FILE *DENY = fopen(pathy, "rb");

    FILE *GAM1 = fopen("../../tides03/0.000wgam1gd1.25.bin", "wb");
    FILE *GAM2 = fopen("../../tides03/0.000wgam2gd1.25.bin", "wb");
