...
data=None
f=h5py.File('/project/mtx/output/tides10/highmass1_0.0012_1.25_NoGau/'+'halo_wdeng1.hdf5','r')
high1_wg1=f['data'][mpi_index[rank].tolist()]
f.close()
f=h5py.File('/project/mtx/output/tides10/highmass1_0.0012_1.25_NoGau/'+'halo_wdeng2.hdf5','r')
high1_wg2=f['data'][mpi_index[rank].tolist()]
f.close()
f=h5py.File('/project/mtx/output/tides10/highmass2_0.0012_1.25_NoGau/'+'halo_wdeng1.hdf5','r')
high2_wg1=f['data'][mpi_index[rank].tolist()]
f.close()
f=h5py.File('/project/mtx/output/tides10/highmass2_0.0012_1.25_NoGau/'+'halo_wdeng2.hdf5','r')
