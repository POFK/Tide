...
#mpirun -hostfile node_hostfile python rsd.py                   $@
mpirun -hostfile node_hostfile python rsd_1.0.py                   $@
mpirun -hostfile node_hostfile python uwkappa_1_smooth_rsd.py  $@
