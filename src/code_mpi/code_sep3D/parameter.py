...
Input='/data/dell1/userdir/maotx/data/tides'+DirNum+'/'+FILEINPUT   #0.000halo_0.0048.hdf5'
InputDelta='/data/dell1/userdir/maotx/data/tides'+DirNum+'/0.000delta.hdf5'
dir='/data/dell1/userdir/maotx/output/tides'+DirNum+'/'+DIRNAME+'/'
...
bins=10
WienerMode=2  # mode1: Ph, mode2: Pd, k-inpendent bias, mode3: pd, k-dependent bias
#================
Kf=2*np.pi/L
...
RunPk2Num=3      #  The Pk number to calculate 
