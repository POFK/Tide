...
#=====1.2 2.4 3.6 4.8==========
range.append(plot_error_one(file='Pk_DD',NAME='CIC_0.0048_3D_NoGau_s1.0_Wiener/',disP=1.0,noise=0,color='k.--',label='$P_{\delta}$'))
...
range.append(plot_error_one(file='Pk_DH',NAME='CIC_0.0024_3D_NoGau_s1.0_Wiener/',disP=1.06,noise=0,color='b<-',label='$0.0024\ (h/\mathrm{Mpc})^{3}$'))
