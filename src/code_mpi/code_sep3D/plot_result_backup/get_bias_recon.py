...
bias_factor={  #  the factor of 1/(b0^2*Q)
        NAME4: 1./(0.838964**2*0.205828),  #0.0048
        NAME3: 1./(0.889876**2*0.166597),  #0.0036
        NAME2: 1./(0.964854**2*0.121419),  #0.0024
        NAME1: 1./(1.110380**2*0.069234),  #0.0012
        }
...
#plt.savefig(OUTDIR+'reconBiasErrorbar.eps')
#plt.show()
