...
#   path2='/project/mtx/output/'+d+'/CIC_0.0024_3D_NoGau_s1.0_Wiener/result_Pd'
...
im = plt.pcolormesh(kx,ky,noise[:7,:7],cmap=cmap,norm=colors.LogNorm(vmin=10**-1, vmax=1*10))
