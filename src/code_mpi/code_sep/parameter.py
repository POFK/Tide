...
#   [InputDelta,0,Input,1,1,1],                              # Pk_dh 
    [InputDelta,0,PathKappaoutput+'2D.hdf5',0,1,0],         # Pk_dk 
#   [Input,1,Input,1,1,1],                                    # Pk_hh 
#   [Input,1,PathKappaoutput+'2D.hdf5',0,1,0],               # Pk_hk 
    [PathKappaoutput+'2D.hdf5',0,PathKappaoutput+'2D.hdf5',0,0,0]# Pk_kk 
    ])
...
#PathWkkappaOutput=dir+'_wfkappa_3d.hdf5'
#======================== get1d_bin par==========================================
