...
dir='/project/mtx/output/tides10/test/'
#Input2='/home/mtx/data/tide/0.000den00.bin'
input1=dir+'Pk_DD.hdf5'
input2=dir+'Pk_DK.hdf5'
input3=dir+'Pk_KK.hdf5'
...
if rank==0:
    ...
    change=np.array(Tide.LoadData('/project/mtx/data/tides10/0.000delta.bin'),dtype=np.float64)
    deltax[:]=change[:]
    ...
    kappax=Tide.LoadDataOfhdf5('/project/mtx/output/tides10/test/halo_wfkappa_2d.hdf5')
...
if rank==0:
    ...
    kappax/=N**3
    Tide.SaveDataHdf5(kappax,'/project/mtx/output/tides10/test/test_kappa.hdf5')
f.close()
g.close()
