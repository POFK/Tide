...
########################## Load data ############################################
if rank == 0 :
    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/halo/0.000halo00_Pk_delta.hdf5')
    Pk_d=f['data'].value
    Pk_d=Pk_d.reshape(8*size,-1)
    f.close()
    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/halo/0.000halo00_Pk_delta_kappa.hdf5')
    Pk_kd=f['data'].value
    Pk_kd=Pk_kd.reshape(8*size,-1)
    f.close()
    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/halo/0.000halo00_Pk_kappa.hdf5')
    Pk_k=f['data'].value
...
if rank==0:
    ...
    W=pk1/(pk1+Pn/(b**2))
    Pd=pk1/kn
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/halo/result_b',b)
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/halo/result_Pn',Pn)
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/halo/result_W',W)
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/halo/result_n',kn)
    np.savetxt('/home/mtx/data/tide/outdata/'+name+'/halo/result_Pd',Pd)
#################################################################################
#b,W,Pn = comm.bcast([b,W,Pn] if rank == 0 else None, root = 0)
#################################################################################
#if rank==0:
#    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/0.000halo00_wkappa3d_x.hdf5')
...
#    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/0.000halo00_result_wfkappax.hdf5',mode='w')
