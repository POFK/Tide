...
inputfile='/home/mtx/data/tide/outdata/test/'+input
Outfile='/home/mtx/data/tide/outdata/test/'+output
#################################################################################
comm = MPI.COMM_WORLD
size = comm.Get_size()
rank = comm.Get_rank()
...
if rank==0:
    ...
    kx=kx_1*Kf/n
    Pk=Pk_1/n
    np.savetxt(Outfile,np.c_[kx,Pk,n])#'/home/mtx/data/tide/outdata/old_test/PS_Pkkd',np.c_[kx,Pk,n])
