...
################################################################################
if rank==0:
    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/halo/'+name2+'/0.000halo00_wkappa3d_x.hdf5')
...
if rank==0:
    ...
    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/halo/'+name2+'/0.000halo00_result_wfkappax.hdf5',mode='w')
    f.create_dataset(name='data',dtype='f8',data=result)
    f.close()
