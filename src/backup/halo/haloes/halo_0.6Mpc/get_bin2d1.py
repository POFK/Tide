...
N=1024
L=1.2*10**3
filename='/home/mtx/data/tide/halo_new/outdata/'
#name='tides00'
#################################################################################
comm = MPI.COMM_WORLD
size = comm.Get_size()
...
if rank==0:
    ...
    np.savetxt(filename+'/result_PS_dd',pk1)
    np.savetxt(filename+'/result_PS_kd',pk2)
    np.savetxt(filename+'/result_PS_kk',pk3)
