...
################################################################################
if rank==0:
    f=h5py.File('/home/mtx/data/tide/halo_new/outdata/log_data/0.000halo00_wkappa3d_x.hdf5')
...
if rank==0:
    ...
    f=h5py.File('/home/mtx/data/tide/halo_new/outdata/log_data/0.000halo00_result_wfkappax.hdf5',mode='w')
