...
char path1[80]   = {"../../tides00/0.000den00.bin"};
char path2[80]   = {"../../tides00/0.000uwkappa10.bin"};
char pathout[80] = {"output/0.000pkuwkap2d1000_up.dat"}; 
    ...
    for(k = 0; k < nn; k++)  {
        ...
        for(j = 0; j < nn; j++)  {
            for(i = 0; i < cn2; i++)  {
                ...
                deltak2 = r_part2*r_part2 + i_part2*i_part2;
