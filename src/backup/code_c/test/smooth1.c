...
#define R    8.        // smoothing scale in unit of Mpc/h
 
char path[80]     = {"/home/zhm/tides01/0.000den00.bin"};
char pathout1[80] = {"/home/mtx/data/tide/outdata/old_test/c_test_data/0.000dens8.bin"}; 
char pathout2[80] = {"/home/mtx/data/tide/outdata/old_test/c_test_data/0.000deng8.bin"};
