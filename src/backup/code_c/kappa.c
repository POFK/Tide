...
char path1[80] = {"../../tides00/0.000wgam1gd1.25.bin"};
char path2[80] = {"../../tides00/0.000wgam2gd1.25.bin"};
char pathout1[80] = {"../../tides00/0.000wkappagd1.25.bin"};
char pathout2[80] = {"../../tides00/0.000wkappbgd1.25.bin"};
