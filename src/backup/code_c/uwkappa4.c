...
char path1[80] = {"../../tides04/0.000wgam110.bin"};
char path2[80] = {"../../tides04/0.000wgam210.bin"};
char pathout1[80] = {"../../tides04/0.000uwkappa10.bin"};
char pathout2[80] = {"../../tides04/0.000uwkappb10.bin"};
