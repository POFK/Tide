...
#################################################################################
b=np.loadtxt('/home/mtx/github/Tide/0.000bias2d00_up.dat')
W=np.loadtxt('/home/mtx/github/Tide/0.000wf2d00_up.dat')
################################################################################
if rank==0:
...
if rank==0:
    ...
    f=h5py.File('/home/mtx/github/Tide/src/0.000den00_result_kappa.hdf5',mode='w')
