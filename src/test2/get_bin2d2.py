...
################################################################################
if rank==0:
    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/0.000den00_wkappa3d_x.hdf5')
...
if rank==0:
    ...
    f=h5py.File('/home/mtx/data/tide/outdata/'+name+'/test/'+name2+'/0.000den00_result_wfkappax.hdf5',mode='w')
