...
\input{./split/performance}
\input{./split/result}
%\section{\label{sec:cross_term}The cross term of $\gamma$}
%\input{./split/last}

\section{\label{sec:discussion}Discussion}
%discuss: if we know all the halos and its mass, we can use the halos field 
%recover dark matter exactly. Different number-density halos mean different
%number of information about dark matter. And because we use the halos counts,
%without the mass information, another problem will be involve. so ...
%=============================================================================
